...
public class TitlePageIndicator extends View implements PageIndicator {
    ...
    private boolean mShowPartOfInactiveTitles;
    ...
    public TitlePageIndicator(Context context, AttributeSet attrs, int defStyle) {
        ...
        final boolean defaultShowOnlyPartOfInactiveTitles = res.getBoolean(R.bool.default_show_only_part_of_inactive_titles);
        ...
        mShowPartOfInactiveTitles = a.getBoolean(R.styleable.TitlePageIndicator_showOnlyPartOfInactiveTitles, defaultShowOnlyPartOfInactiveTitles);
